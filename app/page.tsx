...
import { invitation, mapsUrl } from '@/lib/invitation';
  ...
  return (
    <>
      ...
      <section className="act paper" id="door">
        ...
        <div className="inner">
          <img className="chapel" data-r style={{ ['--i' as string]: 0 }}
            src="/assets/chapel.svg" alt="Line drawing of a chapel" width={600} height={645} />

          <p className="eyebrow" data-r style={{ ['--i' as string]: 1 }}>{v.eyebrow}</p>

          <div className="names">
            <h1 className="name" data-r style={{ ['--i' as string]: 2 }}>{v.first}</h1>
            <span className="amp" data-r style={{ ['--i' as string]: 3 }}>{v.conjunction}</span>
            <p className="name" data-r style={{ ['--i' as string]: 4 }}>{v.second}</p>
          </div>

          <p className="verse" data-r style={{ ['--i' as string]: 5 }}>{v.verse}</p>
      ...
      <section className="act art" id="altar" aria-label="Countdown">
        <div className="inner" data-r><Countdown /></div>
      </section>
      ...
      <section className="act deep" id="light">
        ...
        <Flecks />
        <div className="inner">
          <p className="verse" data-r>{v.verse}</p>
